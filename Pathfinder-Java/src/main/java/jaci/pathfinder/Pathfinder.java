...
/**
 * The main class of the Pathfinder Library. The Pathfinder Library is used for Motion Profile and
...
public class Pathfinder {
    /**
     * Convert degrees to radians. This is included here for static imports. In this library, all
     * angle values are given in radians.
     *
     ...
     * @param config    The configuration of the trajectory, including max velocity, acceleration,
     *                  jerk and other values such as time scale and fit method
